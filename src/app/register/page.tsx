...
export default function RegisterPage() {
  ...
  return (
    <div className="pt-16 min-h-screen">
      {/* Register Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-red-50 to-white py-12">
        ...
        <div className="relative z-10 w-full max-w-lg mx-auto px-4">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-red-900 mt-6 mb-2">
                Create Account
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-red-600 text-white py-3 px-4 rounded-lg font-semibold text-lg hover:bg-red-700 transition-colors duration-300 flex items-center justify-center space-x-2"
              >
