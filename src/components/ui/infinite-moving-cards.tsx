  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-red-200 px-8 py-6 md:w-[450px] bg-white"
            style={{
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className="text-sm leading-[1.6] text-red-800 font-normal">
                    {item.name}
                  </span>
                  <span className="text-sm leading-[1.6] text-red-600 font-normal">
                    {item.title}
                  </span>
                </span>
              </div>
